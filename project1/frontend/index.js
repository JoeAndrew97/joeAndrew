...
$(document).ready(function () {
  ...
  // Call RESTcountries API, assign return value to countriesData
  ...
  $('#countrySelect').on('change', function () {
    ...
    selectedCountry = countriesData.find(function (country) {
      return country.cca2 === selectedCode; // Match the country by ISO code
    });
